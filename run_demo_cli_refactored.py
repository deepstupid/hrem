...
def main(is_fast_mode: bool = False, interactive: bool = False, challenge_key: str = None):
...
if __name__ == "__main__":
    ...
    main(is_fast_mode=args.fast, interactive=args.interactive, challenge_key=args.challenge_key)